...
class SwipeHelperCallback(private val recyclerViewAdapter : AlarmAdapter)  : ItemTouchHelper.Callback() {

    // swipe_view 를 swipe 했을 때 <수정/삭제> 화면이 보이도록 고정하기 위한 변수들
    ...
    // -------------swipe 됐을 때 일어날 동작---------------
    // swipe_view만 슬라이드 되도록 + 일정 범위를 swipe하면 <수정/삭제> 화면 보이게 하기
